                  ...
                  <tbody>
                    ...
                    do {
                      ...
                      do {
                        ...
                        // echo $n;
                        // echo $date;
                        // Check if a payment for the tenant and date already exists
                        $checkPaymentSql = "SELECT * FROM `payment` WHERE tenant_id='$id' AND date='$date' AND description='$desc'";
                        $checkPaymentResult = mysqli_query($con, $checkPaymentSql);
                        $existingPayment = mysqli_fetch_assoc($checkPaymentResult);
                        if(!$existingPayment && $n === $date) {
                          $sql1 = "INSERT INTO `payment`(tenant_id,amount,date,description,date_send,status,consumption) 
														VALUES ('$id','$amount','$date','MONTHLY RENT','$n','Pending',$amount)";
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <p class="p-0 m-0">----------------------------------------------------------------------</p>
            <div class="col-md-12">
              <p class="text-muted p-0 m-0 " style="text-align:center;">AMOUNT:PHP <span id="amounts"></span></p>
            </div>
