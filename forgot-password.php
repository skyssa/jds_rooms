...
if(isset($_POST["reset"])){
  ...
  if(mysqli_num_rows($res) == 1){
    if ($pword != $cpword) {
      ...
      if((strlen($pword) < 1) || (strlen($cpword) < 1)){
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block"><img src="home.jpg" alt="Rental Room" width="500" height="560" style="opacity:0.6;"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><b><b>Rental Room Management System</b></b><br/><br/>Reset Password</h1>
                  </div>
