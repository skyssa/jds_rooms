    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <h1 class="h3 mb-2 text-gray-800" align="center">Room-In Condition</h1>
          <p style="color:red;"><b><b>Please fill the required information upon entering the Room.</b></b></p>
                  ...
                  <tbody>
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      if(mysqli_num_rows($rs) == 0){
                        ...
                        echo "<script type='text/javascript'>
                            Swal.fire({
                              title: 'You have already filled the form. Thank You.',
                              icon: 'success',
                              confirmButtonText: 'Continue'
                            }).then((result) => {
                              if (result.isConfirmed) {
