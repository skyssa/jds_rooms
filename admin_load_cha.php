...
include 'conn.php';
	...
	$insert="insert  into  rental_chat(rent_chat_message,rent_chat_date,rent_chat_time,rent_tenant_id,rent_chat_user,rent_chat_user_id)values('$msg','$Date','$time','$chat_id','Admin','$id')";
	...
	echo'<div class="incoming_msg_img"> <i class="fas fa-user-circle  text-primary" style="font-size:30px;"></i> </div>
            ...
            <div class="received_withd_msg">
                  <p>'.$row['rent_chat_message'].'</p>
                    <span class="time_date"> '.$row['rent_chat_time'].' |  '.$row['rent_chat_date'].'| admin</span></div>
              </div>
            </div>';
