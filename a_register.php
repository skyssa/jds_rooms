...
<body style="background-image: linear-gradient(white,#1cc88a); background-size: cover;">
          ...
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                ...
                <div class="form-group row">
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="pno1" value="<?php echo @$pno; ?>" placeholder="Phone Number e.g; 0922*******" required>
                  </div>
