...
<script>
  function submitChat() {
    ...
    xmlhttp.open('GET','tenant_load_cha.php?msg='+msg,true);
    xmlhttp.send();
    forms.msg.value = '';
  }
  ...
  $(document).ready(function(e){
    ...
    setInterval( function(){$('#incoming_msg').load('tenant_load_view_cha.php'); },1000 );
        setInterval( function(){$('.inbox_chat').load('tenant_load_message.php'); },1000 );
  });
</script>
