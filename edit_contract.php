                   ...
                   <tbody>
                     <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                       <tr>
                         ...
                         <td><input type='text' class='form-control form-control-user' name='id' value = "<?php echo  @$_GET['id']; ?>"  style="width:45%;" readonly></td>
                       </tr>
                     ...
                     <tr>
                       ...
                       <td>
                               <select class="form-control"  id="roomget" style="width:45%">
                           <?php 
                           include 'conn.php';
                       ...
                       <td>
                        ...
                        <input type="text" name="price"  id="price" class="form-control" style="width:45%" >
